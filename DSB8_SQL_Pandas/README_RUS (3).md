...
4. [Глава IV](#глава-iv) \
    4.1. [Упражнение 00. Выборка (SELECT)](#упражнение-00-выборка-select)
5. [Глава V](#глава-v) \
    5.1. [Упражнение 01. Подзапрос (SUBQUERY)](#упражнение-01-подзапрос-subquery)
6. [Глава VI](#глава-vi) \
    6.1. [Упражнение 02. Соединение (JOIN)](#упражнение-02-соединение-join)
7. [Глава VII](#глава-vii) \
    7.1. [Упражнение 03. Агрегации](#упражнение-03-агрегации)
8. [Глава VIII](#глава-viii) \
    8.1. [Упражнение 04. A/B-тестирование](#упражнение-04-ab-тестирование)
...
* Сегодня можно использовать только следующие методы Pandas: io.sql.read_sql и to_sql, если в упражнении не предписано иное.
...
_Небольшой совет: выполняй задание последовательно - от простого к сложному. Так будет проще отлаживать запросы._
